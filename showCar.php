...
?>
  ...
  $result =mysqli_query($vt,"SELECT * FROM arac ORDER BY RAND() LIMIT 10");
  $i=0;
  ...
  { 
          ...
          <p  style='float:center;font-size:15px;font-family:Helvatica;align:center;color:white;'>Günlük Tutar:".$row["aracTutar"]."TL</p>
